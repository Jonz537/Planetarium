...
public class StarSystem {
    ...
    /**
     *
     * @return Restituisce la posizione pesata (centro di massa) di questo sistema stellare
     */
    ...
    /**
     * @return true se esiste una configurazione possibile che causerebbe una collisione tra due qualsiasi corpi celesti
     */
            ...
            for (Planet planet: planets) {
                ...
                for (Moon moon: planet.getMoons()) {
                    ...
                    for (Moon moonToCheck: planetToCheck.getMoons()) {
                        if(!moonToCheck.compareMoon(moon) && moonToCheck.collideWithMoon(moon) && !moonToCheck.getNameFather().equals(moon.getNameFather())) {
                            return true;
                        }
                    }
                }
